...
urlpatterns = [
   ...
   # path('astronaut/', AstronautPageView.as_view(),name='astronaut_page'),   # an astronauts page
    ...
    path('create_team',CreateCrewView.as_view(),name='create_crew'),   # register a crew
